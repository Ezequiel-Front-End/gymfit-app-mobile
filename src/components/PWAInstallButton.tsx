    ...
    <>
      {variant === 'icon' ? (
        <button
          ...
          className="w-8 h-8 rounded-full bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center text-[#D4FF00] transition active:scale-95"
        >
          ...
          <div className="w-full max-w-sm rounded-2xl bg-[#121214] border border-zinc-800 p-6 shadow-2xl text-white">
            ...
            <ol className="space-y-3 text-sm text-zinc-300">
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-zinc-800 text-[#D4FF00] font-bold text-xs flex items-center justify-center shrink-0 mt-0.5">1</span>
                <span>Abra no <strong>Safari</strong> e toque no botão <strong>Compartilhar</strong> (quadrado com seta para cima).</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-zinc-800 text-[#D4FF00] font-bold text-xs flex items-center justify-center shrink-0 mt-0.5">2</span>
                <span>Role para baixo e toque em <strong>"Adicionar à Tela de Início"</strong>.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-zinc-800 text-[#D4FF00] font-bold text-xs flex items-center justify-center shrink-0 mt-0.5">3</span>
            ...
            <button
              onClick={() => setShowIOSModal(false)}
              className="mt-6 w-full rounded-full bg-[#D4FF00] py-2.5 text-sm font-bold text-black hover:brightness-105 transition"
            >
              Entendido
            </button>
          </div>
